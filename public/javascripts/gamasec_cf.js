CloudFlare.define("GamaSec",
    ...
    {		
		...
		function lookForBadge(){
			...
			{
				if(!$("GamaSec-badge")[0] &&!$(".GamaSec-badge")[0] && !$(".GamaSec-embed")[0] && !$("#GamaSec-embed")[0])
				{
					addBadge();
				}
				else
